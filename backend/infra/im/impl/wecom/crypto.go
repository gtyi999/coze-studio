...
func decryptMessage(encodedAESKey, encrypted string) (plainText string, corpID string, err error) {
...
func encryptMessage(encodedAESKey, corpID, plainText string) (string, error) {
	key, err := base64.StdEncoding.DecodeString(encodedAESKey + "=")
	if err != nil {
		return "", err
	}
